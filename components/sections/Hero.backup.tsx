...
function BackgroundEffects() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* Angular red sweep — directional energy from top-right, not a soft blob */}
      <div
        className="absolute right-0 top-0 h-full w-[65%]"
        style={{
          background:
            "linear-gradient(215deg, rgba(255,0,0,0.12) 0%, rgba(255,0,0,0.04) 28%, transparent 58%)",
        }}
      />

      {/* Left accent bar — brand marker, grounds the composition */}
      <div className="absolute left-0 top-0 h-full w-[3px] bg-gradient-to-b from-transparent via-brand-red/50 to-transparent" />
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute left-0 top-0 h-12 w-12">
        <div className="absolute left-0 top-0 h-px w-12 bg-brand-red" />
        <div className="absolute left-0 top-0 h-12 w-px bg-brand-red" />
      </div>
      {/* Red bottom-right corner accent */}
      <div className="absolute bottom-0 right-0 h-12 w-12">
        <div className="absolute bottom-0 right-0 h-px w-12 bg-brand-red" />
        <div className="absolute bottom-0 right-0 h-12 w-px bg-brand-red" />
      </div>
      ...
      >
        ...
        {/* Subtle red right-edge accent */}
        <div className="absolute right-0 top-0 h-full w-[2px] bg-gradient-to-b from-transparent via-brand-red/40 to-transparent" />
